  ...
  <li class="u-msg"
    ...
    >
      <a class="msg-head" v-if="msg.avatar" :href="msg.link">
        <img class="icon u-circle" v-if="msg.flow==='in'" :src="imgUserBaseUrl+this.$store.state.PToPImUserInfo.UserPhotos">
        <img class="icon u-circle" v-else-if="msg.flow==='out'" :src="imgUserBaseUrl+this.$store.state.userInfo.UserPhotos">
      </a>
...
<style lang="scss" scoped="">
  ...
  //         &::before {
  //           right: 99%;
  //           border-right: 0.2rem solid #5cacde;
  //         }
  //         &::after {
  //           background: none;
  //         }
  ...
  //         &::after {
  //           left: 99%;
  //           border-left: 0.2rem solid #e5f4ff;
  //         }
  //       }
  //     }
  //     &.item-time {
  ...
  .u-icon.icon-file {
      background-position: -3.8rem -3.5rem;
  }
</style>