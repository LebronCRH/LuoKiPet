<template>
<div>
  <div class="lh_luokihead" ref="Head">
  <div ref="HelperLine"></div>
     ...
     <ul class="lh_menu">
       ...
       <router-link :to="{ path: '/petactive'}" tag="li" class="lh_menuitem">
       <span ui-sref-active="select" ui-sref="search">活动</span>
       </router-link>
       <router-link :to="{ path: '/pethelperIndex'}" tag="li" class="lh_menuitem">
         <span>助力</span>
       </router-link>
     </ul>
...
<ul class="ul_IndexCategory">
   ...
   <router-link :to="{ path: '/petcategoryIndex'}">
      ...
      <li class="li_IndexCategory">
      <router-link :to="{ path: '/articlecategorydetailsIndex'}">
      <div>
      <div class="div_Icon">
...
<style lang="scss" scoped>
  .Middle{
	...
	.lh_luokihead{
    width:10rem;height:1.5rem;background-color: #38dbb0;position:fixed;left:0rem;top:0rem;z-index: 99;
  	.lh_user{
  		width:1.5rem;float:left;text-align:center;padding:0.35rem 0.35rem;box-sizing: border-box;
  	...
  	.lh_menu{
  		width:7rem;list-style: none;float:left;margin:0;padding: 0;text-align:center;
  		.lh_menuitem{
  			width:33.3%;float:left;display: flex;align-items: center;justify-content: center;
  			span{
  	...
  	.lh_serach{
  		width:1.5rem;float:left;color:#38dbb0;padding:0.35rem 0.35rem;
  	...
  	.ul_IndexCategory{list-style:none;width:100%;padding:0rem;margin:0rem;height:2.8rem;background-color:#fff;margin-bottom:0.2rem;
    	.li_IndexCategory{
        width:2.5rem;height:100%;float:left;display:flex;align-items:center;
        a{color:black;width:100%;height:100%;display:flex;align-items:center;
          div{
              width:2.5rem;height:2.5rem;margin-top:0.2rem;
              .div_Icon{
                width:2.5rem;height:1.2rem;display:flex;justify-content:center;
