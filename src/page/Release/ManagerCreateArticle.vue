    ...
    <scroller ref="scroller" lock-x height="-54" scrollbar-y>
      <div>
        <div class="BigArticle">
          ...
          <input type="file" accept="image/*" ref="filecover" @change="CoverChange()" style="display:none;">         
  ...
  export default {
      ...
      data () {
        return {
          ...
          option:{
            ...
            autoCropHeight: window.screen.width/9.6*8,//自动生成截图框的高度 
      ...
      methods: {
        ...
        ArticleTesting(){
          ...
          }else if(this.ArticleTitle.length>20||this.AarticleSubtitle.length>20){
        ...
        SelectCoverImage(){
          this.$refs.filecover.click();
        },
        CoverChange()
        {
          let file=this.$refs.filecover;
